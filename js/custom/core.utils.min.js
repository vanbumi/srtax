if (typeof ANCORA_GLOBALS == "undefined") {
    var ANCORA_GLOBALS = {}
}
function ancora_get_global(a) {
    return ancora_isset(ANCORA_GLOBALS[a]) ? ANCORA_GLOBALS[a] : ""
}
function ancora_set_global(b, a) {
    ANCORA_GLOBALS[b] = a
}
function ancora_inc_global(b) {
    var a = arguments[1] == undefined ? 1 : arguments[1];
    ANCORA_GLOBALS[b] += a
}
function ancora_concat_global(b, a) {
    ANCORA_GLOBALS[b] += "" + a
}
function ancora_get_global_array(b, a) {
    return ancora_isset(ANCORA_GLOBALS[b][a]) ? ANCORA_GLOBALS[b][a] : ""
}
function ancora_set_global_array(c, a, b) {
    if (!ancora_isset(ANCORA_GLOBALS[c])) {
        ANCORA_GLOBALS[c] = {}
    }
    ANCORA_GLOBALS[c][a] = b
}
function ancora_inc_global_array(c, a) {
    var b = arguments[2] == undefined ? 1 : arguments[2];
    ANCORA_GLOBALS[c][a] += b
}
function ancora_concat_global_array(c, a, b) {
    ANCORA_GLOBALS[c][a] += "" + b
}
function ancora_isset(a) {
    return a != undefined
}
function ancora_empty(a) {
    return a == undefined || (typeof(a) == "object" && a == null) || (typeof(a) == "array" && a.length == 0) || (typeof(a) == "string" && ancora_alltrim(a) == "")
}
function ancora_is_array(a) {
    return typeof(a) == "array"
}
function ancora_is_object(a) {
    return typeof(a) == "object"
}
function ancora_in_array(d, b) {
    var c = false;
...
function ancora_clone_object(c) {
    if (c == null || typeof(c) != "object") {
        return c
    }
    var a = {};
    for (var b in c) {
        a[b] = ancora_clone_object(c[b])
    }
    return a
}
function ancora_in_list(g, d) {
...
function ancora_alltrim(e) {
    var b = arguments[1] ? arguments[1] : "a";
    var d = "";
    var c, f = 0, a = e.length - 1;
    if (b == "a" || b == "l") {
...
function ancora_ltrim(a) {
    return ancora_alltrim(a, "l")
}
function ancora_rtrim(a) {
    return ancora_alltrim(a, "r")
}
function ancora_padl(e, a) {
...
function ancora_round_number(b) {
    var a = arguments[1] ? arguments[1] : 0;
    var c = Math.pow(10, a);
    return Math.round(b * c) / c
}
function ancora_clear_number(c) {
...
function ancora_dec2hex(a) {
    return Number(a).toString(16)
}
function ancora_hex2dec(a) {
    return parseInt(a, 16)
}
function ancora_sort_array(c) {
...
function ancora_get_date_difference(d) {
...
function ancora_components2hex(d, c, a) {
...
function ancora_rgb2components(a) {
    a = ancora_rgb2hex(a);
...
function ancora_hex2hsb(a) {
    return ancora_rgb2hsb(ancora_hex2rgb(a))
}
function ancora_hsb2hex(a) {
    var b = ancora_hsb2rgb(a);
    return ancora_components2hex(b.r, b.g, b.b)
}
function ancora_rgb2hsb(b) {
    var a = {};
...
function ancora_color_picker() {
    ...
    jQuery("#" + e + " table.colorPickerTable").css({"border-collapse": "collapse"});
    jQuery("#" + e).css({
    ...
    jQuery("#" + e + "_colorPreview").css({height: "50px"});
    return e
}
function ancora_color_picker_show(a, d, c) {
    if (a === null || a === "") {
    ...
    jQuery("#" + a).data({field: d, func: c}).css({
        top: j + "px",
        left: e + "px",
        position: "absolute",
        "z-index": 100001
...
function ancora_set_cookie(c, e, a, h, d, g) {
...
function ancora_del_cookie(a, c, b) {
    var c = arguments[1] != undefined ? arguments[1] : "/";
    var b = arguments[2] != undefined ? arguments[2] : "";
    if (ancora_get_cookie(a)) {
        document.cookie = a + "=" + ((c) ? ";path=" + c : "") + ((b) ? ";domain=" + b : "") + ";expires=Thu, 01-Jan-1970 00:00:01 GMT"
    }
}
function ancora_clear_listbox(b) {
    for (var a = b.options.length - 1; a >= 0; a--) {
        b.options[a] = null
    }
}
function ancora_add_listbox_item(b, d, c) {
    var a = new Option();
    a.value = d;
    a.text = c;
    b.options.add(a)
}
function ancora_del_listbox_item_by_value(b, c) {
...
function ancora_del_listbox_item_by_text(c, a) {
...
function ancora_find_listbox_item_by_value(c, d) {
    var a = -1;
    for (var b = 0; b < c.options.length; b++) {
...
function ancora_find_listbox_item_by_text(d, b) {
    var a = -1;
...
function ancora_select_listbox_item_by_value(b, c) {
    for (var a = 0; a < b.options.length; a++) {
        b.options[a].selected = (c == b.options[a].value)
    }
}
function ancora_select_listbox_item_by_text(c, a) {
    for (var b = 0; b < c.options.length; b++) {
        c.options[b].selected = (a == c.options[b].text)
    }
}
function ancora_get_listbox_values(b) {
...
function ancora_get_listbox_texts(b) {
    var d = arguments[1] ? arguments[1] : ",";
    var c = "";
    for (var a = 0; a < b.options.length; a++) {
...
function ancora_sort_listbox(d) {
    var e = new Array();
    var b = new Option();
    for (var c = 0; c < d.options.length; c++) {
...
function ancora_get_listbox_selected_index(b) {
    for (var a = 0; a < b.options.length; a++) {
...
function ancora_get_listbox_selected_value(b) {
    for (var a = 0; a < b.options.length; a++) {
        if (b.options[a].selected) {
...
function ancora_get_listbox_selected_text(b) {
    for (var a = 0; a < b.options.length; a++) {
        if (b.options[a].selected) {
...
function ancora_get_listbox_selected_option(b) {
    for (var a = 0; a < b.options.length; a++) {
        if (b.options[a].selected) {
            return b.options[a]
        }
...
function ancora_get_radio_value(b) {
...
function ancora_set_radio_checked_by_num(c, a) {
...
function ancora_set_radio_checked_by_value(b, c) {
    for (var a = 0; a < b.length; a++) {
...
function ancora_form_validate(c, b) {
    var a = "";
...
function ancora_document_animate_to(e) {
    if (e.indexOf("#") == -1) {
        e = "#" + e
    }
    var d = jQuery(e).eq(0);
...
function ancora_document_set_location(a) {
    try {
...
function ancora_add_hidden_elements_handler(a, b) {
    ancora_set_global_array("init_hidden_elements", a, b)
}
function ancora_init_hidden_elements(a) {
    if (ANCORA_GLOBALS.init_hidden_elements) {
        for (key in ANCORA_GLOBALS.init_hidden_elements) {
            ANCORA_GLOBALS.init_hidden_elements[key](a)
        }
    }
}
...
function ancora_get_file_name(a) {
    a = a.replace(/\\/g, "/");
    var b = a.lastIndexOf("/");
    if (b >= 0) {
        a = a.substr(b + 1)
...
function ancora_get_file_ext(a) {
    var b = a.lastIndexOf(".");
    a = b >= 0 ? a.substr(b + 1) : "";
    return a
}
function ancora_check_images_complete(a) {
    var b = true;
